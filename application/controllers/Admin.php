...
class Admin extends CI_Controller {
	...
	*/
	...
	public function data_info()
	{
		...
		$data['nav'] = $this->load->view('backend/'.$this->user_type.'/include/nav', $this->nav, TRUE);
		$data['menu'] = $this->load->view('backend/'.$this->user_type.'/include/menu', $this->menu, TRUE);
		$this->load->view('backend/'.$this->user_type.'/data_info', $data);
	}

	public function ubah_info()
	{
		if ($this->input->post('simpan', TRUE)) {
			$this->form_validation->set_rules('name', 'Nama Situs', 'required|trim|xss_clean');
            $this->form_validation->set_rules('tagline', 'Tagline Situs', 'required|trim|xss_clean');
            $this->form_validation->set_rules('email', 'Email Situs', 'required');
            $this->form_validation->set_rules('password', 'Password Email', 'required');

            if ($this->form_validation->run() == FALSE) {
            	$this->session->set_flashdata('validasi_eror', 'Nama, Tagline & Email Situs wajib diisi!');
				redirect($this->user_type.'/data-info/','refresh');
				} else {
					$data = array(
					...
					$this->session->set_flashdata('sukses_ubah_info', 'Sukses Mengubah Info Situs!');
					redirect($this->user_type.'/data-info/','refresh');
			        }
		        ...
		        if (! $this->upload->do_upload('gambar')) {
		        	...
		        	redirect($this->user_type.'/tambah-halaman','refresh');
						...
						if (! $this->image_lib->resize()) {
							$this->session->set_flashdata('error_resize_thumbnail', 'Error resize slider:' . $this->image_lib->display_errors());
							}
						...
						if (! $this->image_lib->crop()) {
							$this->session->set_flashdata('error_crop_thumbnail', 'Error crop slider:' . $this->image_lib->display_errors());
							}
						...
						if (! $this->image_lib->resize()) {
							$this->session->set_flashdata('error_resize_gambar', 'Error resize sidebar:' . $this->image_lib->display_errors());
							}
						$config_gambar['image_library'] = 'gd2';
						...
						$this->image_lib->initialize($config_gambar); 
						if (! $this->image_lib->crop()) {
							$this->session->set_flashdata('error_crop_gambar', 'Error crop sidebar:' . $this->image_lib->display_errors());
							}
						...
						$gambar = array(
							"gambar_halaman" => str_replace(" ", "_", $this->input->post('judul')) . "_" . $this->session->userdata('username') . '.jpg',
						);
	...
	*/
	...
	public function pasang_berita()
	{
		if ($this->input->post('isi', TRUE)) {
	        ...
	        if ($this->form_validation->run() == FALSE) {
	          $this->session->set_flashdata('error_form_validation', 'Semua isian harus diisi!');
	          redirect($this->user_type.'/tambah-berita','refresh');
	        	} else {
		        	$data = array(
	...
	public function ubah_berita($id)
	{
		if ($this->input->post('isi', TRUE)) {
	        ...
	        if ($this->form_validation->run() == FALSE) {
	          	...
	          	redirect($this->user_type.'/edit-berita/'.$id,'refresh');
	        	} else {
		        $data = array(
			          "judul_artikel" => $this->input->post('judul', TRUE),
			          "isi_artikel" => $this->input->post('isi', TRUE),
	...
	public function ubah_blog($id)
	{
		if ($this->input->post('isi', TRUE)) {
	        ...
	        if ($this->form_validation->run() == FALSE) {
		        ...
		        if (! $this->upload->do_upload('gambar')) {
		        	$this->session->set_flashdata('success_no_upload', "Sukses Mengedit/Mempublikasikan Blog! <br/>" . $this->upload->display_errors());
		        	redirect($this->user_type.'/edit-blog/'.$id,'refresh');
			        } else {
			        	$uploaddata = $this->upload->data();
						$this->load->library('image_lib');
						...
						$this->session->set_flashdata('success_with_upload', 'Sukses Mengedit/Mempublikasikan Blog dan Gambarnya!');
				        redirect($this->user_type.'/edit-blog/'.$id,'refresh');
	        	}  
	        }
	    } 
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| Fungsi-fungsi yang terkait dengan user
	|--------------------------------------------------------------------------
	|
	| Fungsi-fungsi yang terkait dengan user di bawah ini adalah fungsi yang 
	| hanya ada pada peran Admin
	|
	| Last edited: 2016-07-04 20:48 
	*/

	public function data_user()
	{
		$total_rows = $this->db->select('id_admin')->from('admin')->where('kategori_admin', 'staf')->or_where('kategori_admin', 'kontributor')->count_all_results();

		$this->load->library('pagination');
		$config['base_url'] = site_url($this->user_type.'/data-user');
		...
		$data['data1'] = $this->db->select('admin.*')->from('admin')->where('kategori_admin', 'staf')->or_where('kategori_admin', 'kontributor')->get();
		...
		$data['nav'] = $this->load->view('backend/'.$this->user_type.'/include/nav', $this->nav, TRUE);
		$data['menu'] = $this->load->view('backend/'.$this->user_type.'/include/menu', $this->menu, TRUE);
		$this->load->view('backend/'.$this->user_type.'/data_user', $data);
	}
	...
	public function tambah_user()
	{
		$data['nav'] = $this->load->view('backend/'.$this->user_type.'/include/nav', $this->nav, TRUE);
		$data['menu'] = $this->load->view('backend/'.$this->user_type.'/include/menu', $this->menu, TRUE);
		$this->load->view('backend/'.$this->user_type.'/tambah_user', $data);
	}
	...
	public function daftar_user()
	{
		if ($this->input->post('username')) {
			...
			$this->form_validation->set_rules('kategori', 'Kategori Admin', 'required|trim|xss_clean');
			if ($this->form_validation->run() == FALSE) {
				$this->session->set_flashdata('error_form_validation', 'Semua isian harus diisi!');
				redirect($this->user_type.'/tambah-user','refresh');
			} else {
				$data = array(
						'nama_admin' => $this->input->post('nama'),
						'username_admin' => $this->input->post('username'),
						'password_admin' => $this->input->post('password'),
						'kategori_admin' => $this->input->post('kategori'),
						'email_admin' => $this->input->post('email'),
					);

				$this->db->insert('admin', $data);
				$idAdmin = $this->db->insert_id('admin');
		        ...
		        if (!$this->upload->do_upload('foto')) {
		        	$this->session->set_flashdata('insert_success_no_upload', 'Sukses Menambah User Baru! <br/>' . $this->upload->display_errors());
		        	redirect($this->user_type.'/tambah-user','refresh');
		        } else {
		        	$uploaddata = $this->upload->data();
					$this->load->library('image_lib');
					...
					$this->db->update('admin', $foto, array('id_admin' => $idAdmin));

			        $this->session->set_flashdata('success_insert_with_upload', 'Sukses Menambah User dan Foto Profil!');
			        redirect($this->user_type.'/tambah-user','refresh');
		        }
			}
	...
	public function edit_user($id)
	{
		...
		$data['nav'] = $this->load->view('backend/'.$this->user_type.'/include/nav', $this->nav, TRUE);
		$data['menu'] = $this->load->view('backend/'.$this->user_type.'/include/menu', $this->menu, TRUE);
		$this->load->view('backend/'.$this->user_type.'/edit_user', $data);
	}
	...
	public function ubah_user($id)
	{
		if ($this->input->post('username')) {
			...
			if ($this->form_validation->run() == FALSE) {
				$this->session->set_flashdata('error_form_validation', 'Semua isian harus diisi!');
				redirect($this->user_type.'/edit-user/'.$id,'refresh');
			} else {
				$data = array(
						'nama_admin' => $this->input->post('nama'),
						'username_admin' => $this->input->post('username'),
		        ...
		        if (!$this->upload->do_upload('foto')) {
		        	$this->session->set_flashdata('insert_success_no_upload', 'Sukses Mengedit User! <br/>' . $this->upload->display_errors());
		        	redirect($this->user_type.'/edit-user/'.$id,'refresh');
		        } else {
		        	$uploaddata = $this->upload->data();
					$this->load->library('image_lib');
					...
					$this->db->update('admin', $foto, array('id_admin' => $id));
			...
			$this->session->set_flashdata('error_form_validation', 'Semua isian harus diisi!');
			redirect($this->user_type.'/edit-user','refresh');
		}
	}
	...
	public function hapus_user($id)
	{
        ...
        if($this->input->post('ajax') != '1'){
            echo 'false';
                ...
                if ($this->input->post('id_admin', TRUE)) {
