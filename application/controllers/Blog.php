...
class Blog extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data1'] = $this->ModelArtikel->gabung_artikel_blog_dengan_nama_penulisnya_untuk_halaman_blog($config['per_page'], ($this->uri->segment(3)) ? $this->uri->segment(3) : 0);
		...
		$this->load->view('frontend/beranda/blog', $data);
	}
