...
<div class="wrap">
	...
	<section class="container clearfix">
		...
		<?php } else { ?>
			<?php foreach ($data1->result_array() as $urut => $artikel) {
				...
				if (($urut+1)%3 != 0) { ?>
					<div class="one-third">
						...
						<h4><a href="<?php echo base_url('blog/artikel/'.$artikel['id_artikel'].'/'.$slug_url) ?>"><?php echo $artikel['judul_artikel'] ?></a></h4>
						...
						<a href="<?php echo base_url('blog/artikel/'.$artikel['id_artikel'].'/'.$slug_url) ?>" class="button gray">Read More &rarr;</a>
