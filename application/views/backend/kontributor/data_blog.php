			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Data Blog</h2>
						<div class="box-icon">
						  		...
						  		<?php foreach ($data1->result_array() as $artikel) { ?>
							  		<tr id="tr<?php echo $artikel['id_artikel'] ?>">
										...
										<td class="center">
											...
											<a class="btn btn-info" href="<?php echo site_url('kontributor/edit-blog/'.$artikel['id_artikel']) ?>" title="Edit artikel" data-rel="tooltip">
												<i class="halflings-icon white edit"></i>  
											</a>
											<a class="btn btn-danger" href="#" id="tmblHapus<?php echo $artikel['id_artikel'] ?>" value="<?php echo $artikel['id_artikel'] ?>" title="Hapus artikel" judul="<?php echo $artikel['judul_artikel'] ?>" data-rel="tooltip">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#actHapusArtikel').click(function(event) {
			...
			var link = "<?php echo base_url() ?>";
			$.post(link + 'kontributor/hapus_artikel/' + idArt, {id_artikel: idArt, ajax: 1}, function(data) {
