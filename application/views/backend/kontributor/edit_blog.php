			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('kontributor/ubah_blog/'.$data1[0]['id_artikel'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							...
							<div class="form-actions">
							  	...
							  	<a href="<?php echo site_url("kontributor/data_blog") ?>" name="kembali" class="btn btn-danger">Kembali</a>
							</div>
						  </fieldset>
						<?php echo form_close(); ?>
					</div>
        ...
        $("#actTambahTag").click(function() {
            ...
            $.post(link + 'kontributor/tambah_tag', {tag: tag, ajax: 1}, function(data) {
                ...
                if (data == 'false') {
                    ...
                    $.get(link + 'kontributor/edit_blog', function(cart) {
                        /*optional stuff to do after success*/
...
<script type="text/javascript">
    ...
    var link = "<?php echo base_url() ?>";
        ...
        $("#actTambahKategori").click(function() {
            ...
            $.post(link + 'kategori/tambah_kategori', {kategori: kat, ajax: 1}, function(data) {
                /*optional stuff to do after success*/
                if (data == 'false') {
                    alert("Penambahan kategori artikel gagal!");
                } else{
                    $.get(link + 'kategori/tambah_berita', function(cart) {
                        /*optional stuff to do after success*/
