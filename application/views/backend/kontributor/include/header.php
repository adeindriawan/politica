...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Politica | Kontributor</title>
	...
	<link id="base-style" href="<?php echo base_url() ?>backend/css/jquery.datetimepicker.css" rel="stylesheet">
	<link id="base-style-responsive" href="<?php echo base_url() ?>backend/css/style-responsive.css" rel="stylesheet">
	<link id="base-style" href="<?php echo base_url() ?>backend/css/bootstrap-fileupload.min.css" rel="stylesheet">
...
<body>
	...
	<script src='<?php echo base_url() ?>backend/js/jquery.datetimepicker.js'></script>
	...
	<script src="<?php echo base_url() ?>backend/js/bootstrap-fileupload.js"></script>
	<script src="<?php echo base_url() ?>backend/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
	<!-- end: JavaScript-->
