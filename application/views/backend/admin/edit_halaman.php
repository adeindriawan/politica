			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('admin/ubah_halaman/'.$data1[0]['id_halaman'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							<div class="control-group">
							  	<label class="control-label" for="judul">Judul Halaman</label>
							  	<div class="controls">
									<input type="text" class="span6" id="judul-artikel" placeholder="Isi Judul Artikel" name="judul" value="<?php echo $data1[0]['nama_halaman'] ?>">
							  	</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="gambar-artikel">Gambar Halaman</label>
			                    <div class="controls">
			                    	<?php if ($data1[0]['gambar_halaman'] == NULL) { ?>
			                    		[Tidak ada gambar]
			                    	<?php } else { ?>
			                    		<img width="250px" height="103,75px" src="<?php echo base_url() ?>uploads/images/halaman/slider/<?php echo $data1[0]['gambar_halaman'] ?>">
			                    	<?php } ?>
			                    </div>
			                </div>
							<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  	<label class="control-label" for="textarea2">Isi Halaman</label>
							  	<div class="controls">
									<textarea class="cleditor" id="textarea2" rows="3" name="isi"><?php echo $data1[0]['isi_halaman'] ?></textarea>
							  	</div>
							</div>
							<div class="control-group hidden-phone">
							  	<label class="control-label" for="keterangan">Keterangan Halaman</label>
							  	<div class="controls">
									<textarea id="keterangan" rows="2" name="keterangan"><?php echo $data1[0]['keterangan_halaman'] ?></textarea>
							  	</div>
							</div>
