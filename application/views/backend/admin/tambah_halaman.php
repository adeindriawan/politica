			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Tambah Halaman</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<?php echo form_open_multipart('admin/buat_halaman', array('class' => 'form-horizontal')); ?>
						  <fieldset>
							<div class="control-group">
							  	<label class="control-label" for="judul">Nama Halaman</label>
							  	<div class="controls">
									<input type="text" class="span6" id="judul-artikel" placeholder="Isi Nama Halaman" name="judul">
							  	</div>
							</div>
							<div class="control-group">
							  	<label class="control-label" for="fileInput">Gambar Halaman</label>
							  	<div class="controls">
							...
							<div class="control-group hidden-phone">
							  	...
							  	<div class="controls">
									<textarea id="keterangan" rows="2" name="keterangan"></textarea>
							  	</div>
							</div>
