			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Data Artikel Pending (Ada <?php echo $data3 ?> artikel pending)</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="data-tugas">
						  <thead>
							  <tr>
								  <th>Judul Artikel</th>
								  <th>Penulis</th>
						  ...
						  <tbody>
						  	<?php if ($data1->num_rows() == 0) { ?>
						  		<tr>
						  			<td>Belum ada artikel pending</td>
						  			<td></td>
						  			<td></td>
						  			<td></td>
						  			<td></td>
						  	...
						  	<?php } else { ?>
						  		<?php foreach ($data1->result_array() as $artikel) { ?>
							  		<tr id="tr<?php echo $artikel['id_artikel'] ?>">
										...
										<td class="center">
											<a class="btn btn-success" href="<?php echo site_url('beranda/artikel/'.$artikel['id_artikel']) ?>" title="Lihat artikel" data-rel="tooltip">
												<i class="halflings-icon white zoom-in"></i>  
											</a>
											<a class="btn btn-info" href="<?php echo site_url('admin/edit-blog/'.$artikel['id_artikel']) ?>" title="Edit artikel" data-rel="tooltip">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#actHapusArtikel').click(function(event) {
			...
			var link = "<?php echo base_url() ?>";
			$.post(link + 'admin/hapus_artikel/' + idArt, {id_artikel: idArt, ajax: 1}, function(data) {
