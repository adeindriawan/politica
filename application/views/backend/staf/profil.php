			...
			<div class="row-fluid sortable">
				<div class="box span8">
					...
					<div class="box-content">
						<?php echo form_open_multipart('staf/ubah_profil/'.$data1[0]['id_admin'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="username">Username</label>
							  <div class="controls">
								<input type="text" class="span6" id="username" value="<?php echo $data1[0]['username_admin'] ?>" placeholder="Username Staf" name="username">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="password">Password</label>
							  <div class="controls">
								<input type="text" class="span6" id="password" value="<?php echo $data1[0]['password_admin'] ?>" placeholder="Password Staf" name="password">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="nama">Nama Lengkap</label>
							  <div class="controls">
								<input type="text" class="span6" id="nama" value="<?php echo $data1[0]['nama_admin'] ?>" placeholder="Nama Lengkap Staf" name="nama">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="lahir">Tanggal Lahir</label>
							  <div class="controls">
								<input type="text" class="span6" id="lahir" value="<?php echo $data1[0]['tanggal_lahir_admin'] ?>" placeholder="Tanggal Lahir Staf" name="lahir">
							  </div>
							</div>
							<div class="control-group">
