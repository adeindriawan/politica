...
<script type="text/javascript">
	$(document).ready(function() {
		$('#actEditKategori').click(function(event) {
			...
			var link = "<?php echo base_url() ?>";
			$.post(link + 'staf/edit_kategori/' + idKategori, {id_kategori: idKategori, kategori: jdKategori, ajax: 1}, function(data) {
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#actHapusArtikel').click(function(event) {
			...
			var link = "<?php echo base_url() ?>";
			$.post(link + 'staf/hapus_kategori/' + idArt, {id_kategori: idArt, ajax: 1}, function(data) {
				/*optional stuff to do after success */
				if (data == "true") {
					$('#cnfHapusArtikel').modal('hide');
...
<div class="modal hide fade" id="tmbhKategori">
	...
	<div class="modal-body tambah-kategori">
		<?php echo form_open('staf/tambah_kategori'); ?>
