			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('staf/ubah_blog/'.$data1[0]['id_artikel'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							...
							<div class="form-actions">
							  	...
							  	<a href="<?php echo site_url("staf/data_blog") ?>" name="kembali" class="btn btn-danger">Kembali</a>
							</div>
						  </fieldset>
						<?php echo form_close(); ?>
					</div>
...
<div class="modal hide fade" id="tagModal">
	...
	<div class="modal-body tambah-tag">
		<?php echo form_open('staf/tambah_tag'); ?>
