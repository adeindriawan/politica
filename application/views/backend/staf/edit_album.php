			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('staf/ubah_album/'.$data1[0]['id_album'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							...
							<div class="form-actions">
							  ...
							  <a href="<?php echo site_url('staf/data-album') ?>" class="btn btn-danger">Kembali</a>
							</div>
						  </fieldset>
						<?php echo form_close(); ?>
					</div>
