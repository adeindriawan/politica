			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('dashboard/ubah_blog/'.$data1[0]['id_artikel'], array('class' => 'form-horizontal')); ?>
						  <fieldset>
							...
							<div class="form-actions">
								<?php if (!is_null($this->session->userdata('bisa_ubah_blog'))) { ?>
									<button type="submit" class="btn btn-primary">Ubah Blog</button>
									<a href="<?php echo site_url("dashboard/data_blog") ?>" name="kembali" class="btn btn-danger">Kembali</a>
								<?php } ?>
							</div>
						  </fieldset>
						<?php echo form_close(); ?>
