			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<?php echo form_open_multipart('dashboard/buat_blog', array('class' => 'form-horizontal')); ?>
						  <fieldset>
							...
							<div class="form-actions">
							  	...
							  	<a href="<?php echo site_url("dashboard/data-blog") ?>" name="kembali" class="btn btn-danger">Kembali</a>
							</div>
						  </fieldset>
						<?php echo form_close(); ?>
					</div>
