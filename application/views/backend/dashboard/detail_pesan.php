	...
	<?php echo $menu; ?>
		...
		<div id="content" class="span10">
			...
			<div class="row-fluid sortable">		
				...
				<?php if (!is_null($this->session->userdata('bisa_balas_pesan'))) { ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#balas-pesan").click(function(event) {
			...
			$.post(link + 'dashboard/balas_pesan', {ajax: 1, isi: isi, email: ema, id_pesan: idp}, function(data) {
				...
				if (data == 'false') {
					...
					$("#balas").modal('hide');
					$("#sksBalas").modal('show');
					window.location = link + 'dashboard/detail-pesan/' + idp;
				};
			});
		});
	});
