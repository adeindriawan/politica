...
<ul class="breadcrumb">
	<?php switch ($this->uri->segment(2)) {
		case '':
			...
			echo '<a href="'.base_url().'dashboard'.'">Beranda</a>';
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-dashboard"></i><a href="' . base_url() .'admin">Dashboard</a></li>';
			break;
		...
		case 'data-info':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-credit-card"></i><a href="' . base_url() . 'data-info">Info Situs</a></li>';
			break;
		...
		case 'detail-berita':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-edit"></i><a href="' . base_url() . 'detail-berita/'.$this->uri->segment(3).'">Detail Berita</a></li>';
			break;
		...
		case 'edit-blog':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-edit"></i><a href="' . base_url() . 'edit-blog/'.$this->uri->segment(3).'">Detail Blog</a></li>';
			break;
		...
		case 'data-galeri':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-list"></i><a href="' . base_url() . 'data-galeri">Data Galeri</a></li>';
			break;
		...
		case 'tambah-galeri':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-plus"></i><a href="' . base_url() . 'tambah-galeri">Tambah Galeri</a></li>';
			break;
		...
		case 'edit-galeri':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-edit"></i><a href="' . base_url() . 'detail-galeri/'.$this->uri->segment(3).'">Detail Galeri</a></li>';
			break;
		...
		case 'data-tugas':
			...
			echo '<i class="icon-angle-right"></i>';
			echo '</li>';
			echo '<li><i class="icon-table"></i><a href="' . base_url() . 'data-table/">Data Tugas</a></li>';
			break;
