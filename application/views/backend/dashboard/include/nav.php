				...
				<ul class="nav pull-right">
						...
						<ul class="dropdown-menu notifications">
							...
							<?php foreach ($notif as $key => $value) { ?>
								<?php switch ($value['tipe_notifikasi']) {
									...
									case 'persetujuan': ?>
										<li>
		                                    <a href="<?php echo site_url($value['jenis_artikel'].'/artikel/'.$value['id_artikel']) ?>">
									...
									case 'pesan': ?>
										<li>
		                                    <a href="<?php echo site_url('dashboard/detail-pesan/'.$value['id_pesan']) ?>">
												<span class="icon blue"><i class="icon-check"></i></span>
							...
							<?php } ?>
							<li class="dropdown-menu-sub-footer">
                        		<a href="<?php echo site_url('dashboard/data-notifikasi') ?>">Lihat semua notifikasi</a>
							</li>	
						</ul>
					</li>
					...
					<li class="dropdown hidden-phone">
						...
						<ul class="dropdown-menu tasks">
							...
							<?php } ?>
							<li>
                        		<a href="<?php echo site_url('admin/data-tugas') ?>" class="dropdown-menu-sub-footer">Lihat semua tugas</a>
							</li>	
						</ul>
					</li>
					<!-- end: Tasks Dropdown -->
