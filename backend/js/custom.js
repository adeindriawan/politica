...
$(document).ready(function(){
	...
	init_masonry();
	sparkline_charts();
	// charts(); // Modifikasi #3: dihilangkan karena dipindah ke file index masing-masing
	calendars();
...
function template_functions(){
	...
	/* ---------- Modifikasi #1: Uniform (yang asli, tidak dipakai karena mengikutsertakan input:file) ---------- */
...
// Modifikasi #2: Fungsi berikut ini sudah dipindah ke file index.
