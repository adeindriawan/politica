...
/* ---------------------------------------------------------------------- */
	...
	// tiga library JS di bawah ini dihilangkan agar tidak berlaku
...
jQuery(document).ready(function($) {
	...
	// Modifikasi #1: mengubah lokasi referensi include untuk flexslider
	// if ($('#slider').length) {
	...
	if ($('#slider').length) {
		$.include('frontend/sliders/flexslider/jquery.flexslider-min.js');
		$(window).load(function() {
			$('#slider img').css('visibility','visible').fadeIn();
			$('#slider').flexslider({
				directionNav: true,
